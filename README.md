...
| 📈 [OTelBot With Aspire](dotnet/OTelBotWithAspire)   | `Dotnet`    | A Teams echo bot with .NET Aspire and built-in OpenTelemetry observability.               | `#dotnet` `#aspire` `#opentelemetry` `#observability`               |
