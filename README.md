...
| 🤖 [Agent 365 Teams Agent](dotnet/A365TeamsAgent)      | `Dotnet`    | Agent 365-aware Teams bot using Work IQ MCP tools, Azure OpenAI, delegated identity, and OpenTelemetry. | `#agent-365` `#work-iq` `#mcp` `#azure-openai` `#opentelemetry`          |
| 📈 [OTel Bot with Aspire](dotnet/OTelBotWithAspire)    | `Dotnet`    | Teams echo bot with .NET Aspire orchestration and OpenTelemetry traces, metrics, and logs.             | `#dotnet` `#aspire` `#opentelemetry` `#teams-bot`                       |
